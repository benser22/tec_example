...
function TailwindComponent() {
  return (
    <div className="bg-gray-200 p-6">
      <h1 className="text-3xl font-bold text-blue-600">Tailwind CSS Example</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        ...
        <div className="bg-white p-4 rounded shadow-md">
          ...
          <div className="bg-blue-200 p-2 rounded-lg mt-2">
            ...
            <p className="text-sm text-gray-600">Some card content goes here.</p>
          </div>
        </div>
      </div>
      
      <div className="mt-6">
        <p className="text-red-500 font-semibold">This is a red warning message.</p>
      </div>
    </div>
  );
}
